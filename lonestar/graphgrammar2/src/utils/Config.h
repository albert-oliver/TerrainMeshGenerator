...
public:
    ...
    Config(int argc, char **argv) : tolerance(1), version2D(false), steps(30), cores(-1), display(false), N(50.2), S(49.3),
                                    E(20.7), W(19.2), dataDir("data"), ascii(false), asciiFile(""),
                                    output(string("out/graph") + std::to_string(galois::getActiveThreads()) + ".mgf") {
